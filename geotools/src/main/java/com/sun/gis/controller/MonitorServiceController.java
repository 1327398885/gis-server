...
import com.sun.gis.response.ResponseCode;
import com.sun.gis.response.ResponseResult;
...
public class MonitorServiceController {
    ...
    @ApiOperation(value = "获取服务度量指标", notes = "获取服务度量指标")
    ...
    public ResponseResult getMetrics() {
        ...
        resMap.put("metricsData", metricsData);
        resMap.put("metricComments", METRIC_NAME_TO_CHINESE_COMMENT);
        return new ResponseResult(ResponseCode.SUCCESS, resMap);
    }
